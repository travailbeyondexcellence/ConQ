...
const Logo: React.FC<LogoProps> = ({ size = 32, ...props }) => (
  ...
  >
    ...
    />
    <path fill="#ffffff" d="M54 12a6 6 0 1 0 6 6c0-3.313-2.688-6-6-6z" />
    <path fill="#FF4B39" d="M54 14a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />
    <path
      fill="#00BD9C"
    ...
    />
    <path fill="#23475F" d="M26 13h-2v10h2V13z" />
    <path
      fill="#BCC4C8"
